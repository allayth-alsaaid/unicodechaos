...
يبني Unicode Chaos نصاً **لعشوائية خالصة لا لأي معنى**. حروف من 170 سكريبت تصطدم بالرموز والأرقام والإيموجي عبر محرك عشوائي مُدرَّج: السكريبتات المألوفة أولًا (≈2.5% لكل منها)، ثم فئات القوائم (≈1.2%)، والنادرة حاضرة بنسبة منخفضة (≈0.08%) — وكل سحبة مستقلة.
...
| الفحص | النتيجة |
|---|---|
| سحب مُدرَّج، طول 17600 | أساسي 81% · قوائم 7% · نادر 11% · إيموجي ≈ 1.3% · 176/176 مدخلًا تظهر |
