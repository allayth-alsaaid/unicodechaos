...
يبني Unicode Chaos نصاً **لعشوائية خالصة لا لأي معنى**. حروف من 170 سكريبت تصطدم بالرموز والأرقام والإيموجي عبر محرك عشوائي منتظم: كل فئة وسكريبت وحرف باحتمال متساوٍ، وكل سحبة مستقلة.
...
عشوائية النظام (256 بت) + jitter + طابع ميكروثاني + عدّاد
   ...
   البذرة (64 خانة ست عشرية)
        ...
        ▼
فئة ← سكريبت ← حرف   (منتظم في كل مرحلة)
        │
        ▼
  نص مرئي (الطول يُحسب بالـgraphemes — الإيموجي = 1)
```

- **سحب بثلاث مراحل:** فئة منتظمة، ثم سكريبت منتظم، ثم code point منتظم من مدياته. بلا أوزان ولا تعزيز ولا قواعد ضد التكرار — النسب تتبع الصدفة لا خطة.
...
| الفحص | النتيجة |
|---|---|
| سحب منتظم، طول 7000 | 7/7 فئات ≈ 14.3% لكل منها · 170/170 سكريبت مغطاة |
