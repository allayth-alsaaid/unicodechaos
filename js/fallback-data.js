window.__CHAOS_FALLBACK__={scripts:
[
  {
    "id": "latin",
    "core": true,
    ...
    "note": "Includes Turkish ç ğ ı ö ş ü via ranges"
  },
  {
    "id": "arabic",
    "core": true,
...
,symbols:{"math": ["∞", "∑", "√", "∫", "≈", "≠", "≤", "≥", "±", "×", "÷", "∂", "∆", "∏", "∝", "∠", "∧", "∨", "∩", "∪", "∴", "∀", "∃", "∈", "∋", "∅", "∇", "⊕", "⊗", "≡", "≅", "⊂", "⊃", "⊆", "⊇", "⊥", "⊿", "⋆"], "arrows": ["→", "←", "↑", "↓", "↔", "↕", "⇄", "⇅", "⇒", "⇐", "⇑", "⇓", "⇔", "↗", "↘", "↙", "↖", "⟶", "⟵", "↦", "↤"], "shapes": ["★", "☆", "◆", "◇", "■", "□", "●", "○", "▲", "△", "▼", "▽", "◀", "▶", "⬛", "⬜", "◼", "◻", "⬢", "⬣", "⯁", "⯅"], "cards": ["♠", "♥", "♦", "♣", "♤", "♡", "♢", "♧"], "music": ["♪", "♫", "♬", "♩", "♭", "♮", "♯"], "tech": ["⌘", "⌥", "⌫", "⏎", "⏻", "⏼", "␣", "⎋", "⌨", "⚙", "⛭", "⌁", "⏷"], "misc": ["©", "®", "™", "§", "¶", "†", "‡", "•", "◦", "‣", "⁂", "☀", "☁", "☂", "☃", "☾", "☽", "♻", "⚡", "⚠", "☮", "☯", "⚛", "☸", "✈", "✂", "✉", "✌", "☎", "⛔", "✅", "❌", "‼", "⁉"]}
,emoji:["😀", "😂", "🤣", "😭", "💀", "🔥", "❤️", "🚀", "🚗", "🗿", "😎", "🤖", "👾", "🌚", "🌞", "⭐", "💥", "✨", "🎉", "🎮", "🍕", "🍣", "🐉", "🦄", "🐙", "🌊", "🏔", "🌋", "🌀", "⚡", "💎", "👑", "🎭", "🎨", "📚", "🔮", "🧬", "🛸", "🏯", "🗺", "💰", "🔑", "🧸", "🎁", "🏆", "🥇", "⚽", "🎲", "🃏", "🎰", "📸", "🎧", "🥁", "🎺", "🚲", "✈️", "🚂", "🐫", "🦂", "🌵", "🍀", "🌙", "☄️", "👁️", "🧠", "🫀", "👣", "🧿", "📿", "🪬", "🖥"]
,unicode:{
  "numbers": {
    "latin": [
