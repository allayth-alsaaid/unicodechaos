...
(function (global) {
  ...
  var STR = {
    en: {
      ...
      generate: 'Generate', ctlTitle: 'Configure', outTitle: 'Output',
      ...
      specP: 'Live samples pulled from ten writing systems.',
    ...
    ar: {
      ...
      generate: 'ولّد', ctlTitle: 'الإعداد', outTitle: 'الناتج',
      ...
      specP: 'عينات حية من عشر منظومات كتابة.',
